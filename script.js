...
function createScaleButton(qIndex, value, label) {
    ...
    const icons = { 1: '<i class="fa-regular fa-face-smile-beam"></i>', 2: '<i class="fa-regular fa-face-meh"></i>', 3: '<i class="fa-regular fa-face-frown-open"></i>', 4: '<i class="fa-regular fa-face-dizzy"></i>' };
    return `
